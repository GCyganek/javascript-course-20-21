function drawPieChart(data, chartTitle, canvasId) {
    ...
    for (label in data) {
        ...
        context.fillStyle = colors[color_index];
        context.textAlign = "center";
        context.fillText(label + ": " + Math.round(100 * data[label] / data_value) + "%", LEGEND_LEFT + GRAPH_AND_LEGEND_WIDTH / 2, LEGEND_TOP - 10 + (color_index + 1) * GRAPH_AND_LEGEND_HEIGHT / data_size);
        color_index += 1;
        context.closePath();
    }
}